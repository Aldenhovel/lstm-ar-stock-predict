...
class LSTMDecoderL(nn.Module):
    def __init__(self, vocab_size, hidden_dim=512, layer=2, bi=True, device=torch.device("cpu")):
        ...
        self.fc = nn.Linear(in_features=hidden_dim*self.bi_factor, out_features=hidden_dim*self.bi_factor)
        self.fc2 = nn.Linear(in_features=hidden_dim*self.bi_factor, out_features=vocab_size)
